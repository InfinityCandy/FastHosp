...
@section('titulo', 'Registrar Personal Administrativo')
...
@section('principal')
   @section('boxTitle', 'Registrar Personal Administrativo')
  
   <form method="post" action="../administrarAdministrativos" enctype="multipart/form-data">
        ...
        <fieldset class="form-style-5">
            ...
            <div class="col-md-3 form-group">
                <label for="GradoDeEstudios">Tipo</label>
                <select class="form-control" name="tipo" id="tipo">
                    <option value="G">General</option>
                    <option value="F">Medicina Familiar</option>
