...
@section('principal')
   ...
   <form method="post" action="../finalizarConsultaUrgencias" enctype="multipart/form-data">
      
       <input type="hidden" name="_token" value="{!! csrf_token() !!}">
       <input type="hidden" name="expedientePaciente" id="expedientePaciente" value="{{$pacienteInfo->pacienteExpediente}}">
       <input type="hidden" name="expedienteMedico" id="expedienteMedico" value="{{$expedienteMedico}}">
       <input type="hidden" name="horaDeConsulta" id="horaDeConsulta" value="{{$horaDeConsulta}}">
