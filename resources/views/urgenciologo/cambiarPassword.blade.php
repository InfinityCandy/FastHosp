...
@section('principal')
   @section('boxTitle', 'Cambiar Contraseña')
    <form method="post" action="../urgenciologoCambiarPassword" onsubmit="return validar()">
        ...
        <script>
            function validar() {
                ...
                if(oldPassword.value == "") {
                    document.querySelector("#errorTextChangePass").innerHTML = "Error: Escriba su contraseña actual.";
                    flag = false;
                }
                else {
                    if(newPassword.value == "") {
                        document.querySelector("#errorTextChangePass").innerHTML = "Error: La nueva contraseña no puede estar en blanco.";
                        flag = false;
                    }
                    else {
                        if(newPassword.value == newPasswordVerify.value) {
                            ...
                            document.querySelector("#errorTextChangePass").innerHTML = "Error: Las contraseñas no  coinciden.";
                            flag = false;  
                        }
                    }
                } 
